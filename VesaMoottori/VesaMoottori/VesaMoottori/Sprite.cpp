...
void Sprite::setPosition(vector3i position)
{
	_position = position;
}
vector3i Sprite::getPosition()
{
	return _position;
}
...
GLfloat* Sprite::getVertexData()
{
	...
	GLfloat AVERTEX_DATA[32] =
	{
		_position.x, _position.y, _position.z,
		_red, _blue, _green,
		0.0f, -1.0f,

		_position.x, _position.y + _sourceRectSize.y, _position.z,
		_red, _blue, _green,
		0.0f, 0.0f,

		_sourceRectSize.x + _position.x, _sourceRectSize.y + _position.y, _position.z,
		_red, _blue, _green,
		1.0f, 0.0f,

		_sourceRectSize.x + _position.x, _position.y, _position.z,
		_red, _blue, _green,
		1.0f, -1.0f
	};
	for (int i = 0; i < 32; i++)
